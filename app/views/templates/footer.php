	    ...
	    <!-- Bootstrap -->
	    <script src="<?= BASEURL; ?>/vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
	    <!-- sweetAlert -->
	    ...
	    <script src="<?= BASEURL; ?>/vendors/dropzone/dist/min/dropzone.min.js"></script>

	    <!-- Custom Theme Scripts -->
	    <script src="<?= BASEURL; ?>/vendors/build/js/custom.min.js"></script>
	</body>
</html>